    ...
    messages: [
      {
        role: "system",
        content: `
          Generate new LinkedIn post suggestions based on your past data. Provide the topic and details of your previous posts, including target audience, tone, and keywords. Our AI will analyze your data to generate 5-6 tailored suggestions to help you create engaging content for your audience
          past data = ${data}
